...
# installed.
TCL_PREFIX='/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0/include'
...
TCL_PACKAGE_PATH='/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='-------src-dir-------/tcl8.5.15/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tmp/heroku-buildpack-sphinx/src/miniconda-3.6.0/lib/libtclstub8.5.a'
